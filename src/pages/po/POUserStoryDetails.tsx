...
export default function POUserStoryDetails() {
            ...
            <div className="space-y-6 animate-fade-in">
                ...
                <div className="flex items-start justify-between">
                    ...
                    <div className="flex gap-2">
                        <Button variant="outline" onClick={() => navigate(`/po/user-stories/${id}/edit`)}>
                            ...
                            <CardContent>
                                {tasks.length > 0 ? (
                                    ...
                                    <div className="text-center py-12">
                                        ...
                                        <Button onClick={() => navigate(`/pm/tasks/create?userStoryId=${id}`)}>
