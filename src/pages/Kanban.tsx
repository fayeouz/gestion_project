...
const columns = [
  { id: 'pending', title: 'À Faire', color: 'border-warning' },
  { id: 'active', title: 'En Cours', color: 'border-secondary' },
  { id: 'completed', title: 'Terminé', color: 'border-success' },
];
      ...
      <Layout>
        <div className="space-y-6 animate-fade-in">
          <div>
            ...
            <p className="text-muted-foreground">Glissez-déposez les tâches pour mettre à jour leur statut</p>
          </div>
